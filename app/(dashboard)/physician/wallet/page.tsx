  ...
  return (
    <div className="max-w-6xl">
      <div className="mb-7">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Commission earnings and withdrawal history</p>
      </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-100 dark:border-gray-700 bg-gray-50/60 dark:bg-gray-700/40">
                  ...
                  <th className="text-right px-5 py-3.5 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Commission Rate</th>
