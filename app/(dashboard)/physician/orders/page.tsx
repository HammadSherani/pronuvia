    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">All orders you have placed ({total} total)</p>
        </div>
                  ...
                  return (
                    <tr key={o.id} className="hover:bg-gray-50/50 dark:hover:bg-gray-700/50 transition-colors">
                      ...
                      <td className="px-5 py-4">
                        ...
                        <span className="text-xs text-gray-400 dark:text-gray-500 ml-1">({o.physicianCommissionRate}%)</span>
                      </td>
                      <td className="px-5 py-4">
