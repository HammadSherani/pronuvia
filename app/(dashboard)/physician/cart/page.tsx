...
export default function PhysicianCartPage() {
  ...
  if (items.length === 0) {
    return (
      <div className="max-w-2xl mx-auto text-center py-24">
        ...
        <h1 className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-2">Your cart is empty</h1>
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">Add products from the shop to get started.</p>
        ...
        <div className="lg:col-span-2 space-y-3">
          {items.map((item) => (
            <div key={item.cartId}
              ...
              <Link href={`/physician/shop/${item.productSlug}`} className="shrink-0">
              ...
              <div className="flex-1 min-w-0">
                <Link href={`/physician/shop/${item.productSlug}`}>
                  <p className="text-sm font-semibold text-gray-800 dark:text-gray-100 hover:text-[#3DBFA4] transition-colors truncate">
                    {item.productTitle}
                  </p>
                </Link>
