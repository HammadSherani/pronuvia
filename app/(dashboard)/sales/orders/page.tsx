...
export default async function SalesOrdersPage() {
  ...
  const totalCommission = orders.reduce((s, o) => s + o.salesRepCommissionAmount, 0);
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-3 gap-5 mb-6">
        {[
          { label: "Total Orders",        value: orders.length,           color: "#3DBFA4", prefix: "" },
          { label: "Total Spent",         value: fmt(totalSpent),         color: "#5BB8D4", prefix: "" },
          { label: "Your Commission",     value: fmt(totalCommission),    color: "#8b5cf6", prefix: "" },
        ].map((c) => (
