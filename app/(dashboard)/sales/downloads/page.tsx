  ...
  return (
    <div className="max-w-3xl">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Educational and sales materials provided by Pronuvia.</p>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm overflow-hidden">
        ...
        {docs.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">Check back later - materials will appear here when uploaded.</p>
          </div>
        ) : (
