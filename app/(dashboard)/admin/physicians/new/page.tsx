...
export default async function NewPhysicianPage() {
  ...
  return (
    <div className="max-w-3xl">
      ...
      <div className="mb-6">
        <h1 className="text-xl font-bold text-gray-800 dark:text-gray-100">Add Partnering Physician</h1>
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Choose to approve immediately or place in pending for later review.</p>
      </div>
