import { listDocuments, deleteDocument } from "@/actions/admin/manage-catalog";
              ...
              <li key={doc.id} className="flex items-center gap-4 px-5 py-4 hover:bg-gray-50/50 transition-colors group">
                ...
                <div className="flex items-center gap-3 opacity-0 group-hover:opacity-100 transition-opacity">
                  ...
                  <DeleteButton
                    ...
                    modalTitle="Delete this document?"
                    modalDescription={`"${doc.fileName}" will be permanently removed and will no longer be available to sales reps or physicians.`}
                  />
                </div>
              </li>
            ))}
