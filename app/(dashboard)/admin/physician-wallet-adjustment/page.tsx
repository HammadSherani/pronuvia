    ...
    <div>
      ...
      <div className="grid grid-cols-2 gap-5 mb-6">
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm p-5">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Approved Physicians</p>
        </div>
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm p-5">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Total Wallet Value</p>
        </div>
      </div>
