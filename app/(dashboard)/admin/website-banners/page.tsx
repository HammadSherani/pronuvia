  ...
  return (
    <div>
      <PageHeader
        ...
        description={`Banners that appear on the public home page hero carousel (${total} total)`}
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-100 dark:border-gray-700 bg-gray-50/60 dark:bg-gray-700/40">
                  ...
                  <th className="text-left px-5 py-3.5 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Content</th>
                ...
                {banners.map((banner) => (
                  <tr key={banner.id} className="hover:bg-gray-50/50 dark:hover:bg-gray-700/50 transition-colors">
                    ...
                    <td className="px-5 py-3.5 max-w-xs">
                      <p className="font-medium text-gray-800 dark:text-gray-100 truncate">{banner.title}</p>
                      {banner.subtitle && (
                        <p className="text-xs text-gray-400 dark:text-gray-500 truncate mt-0.5">{banner.subtitle}</p>
                      )}
                      {banner.linkUrl && (
