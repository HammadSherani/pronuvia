  ...
  return (
    <>
      <button
        ...
        className="w-7 h-7 inline-flex items-center justify-center bg-[#5BB8D4]/10 text-[#5BB8D4] border border-[#5BB8D4]/30 rounded-lg hover:bg-[#5BB8D4]/20 transition-colors mx-auto"
      >
