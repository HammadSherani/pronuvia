    ...
    >
      ...
      {uploading ? (
        ...
        <>
          ...
          <div className="inline-flex items-center gap-1.5 px-4 py-2 bg-white border border-gray-200 rounded-lg text-sm text-gray-600 dark:text-gray-400 shadow-sm">
          ...
          <p className="text-xs text-gray-400 dark:text-gray-500 mt-4">PDF only · max 20 MB</p>
        </>
      )}
    </div>
  );
